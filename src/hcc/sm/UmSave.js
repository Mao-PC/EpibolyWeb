...
import { initOrgSelectTree, initRoleSelect } from '../../comUtil';
...
class Save extends Component {
	...
	render() {
		...
		const { areaTreeSelect, roleData } = this.state;
